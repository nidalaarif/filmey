                    ...
                    <div class="movie-img sticky-sb">
                        ...
                        <div class="movie-btn">
                            <div class="btn-transform transform-vertical red">
                                ...
                                <div><a href="{{ $data['details']->trailer_link }}"
                            ...
                            <div class="rate-star movie_category cate">
                                ...
                                @foreach($data['genre'] as $cat)
                                    <span class="blue" style="background-color: {{ $cat->category_color }};"><a
                                            href="/category/{{ $cat->category_name }}">{{ $cat->category_name }}</a></span>
                                @endforeach
                            </div>
                        </div>
                                    ...
                                    <div id="overview" class="tab active">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-xs-12 col-sm-12">
                                                ...
                                                <div class="sb-it">
                                                    <h6>Release Date:</h6>
                                                    <p>{{ $data['details']->released }}</p>
                                                </div>
                                                <div class="sb-it">
                                                    <h6>Runtime:</h6>
                                                    <p>{{ $data['details']->runtime }}</p>
                                                </div>
                                                <div class="sb-it">
                                                    <h6>IMDB Rating:</h6>
                                        ...
                                        <div class="row">
                                            <div>
                                                @if(count($data['links']) > 0)
                                                    @foreach($data['links'] as $link)
                                                        <button id="play_torrent" class="button"
                                                                onclick="playIt('{{ asset('/'.$link->link) }}','{{ $link->quality_type }}')">
                                                            Play {{ $link->quality_type }}</button>
                                                    @endforeach
                                                @else
                                                    <p> sorry no links</p>
                                                @endif
                                            ...
                                            @if(count($data['related']) > 0)
                                                @foreach($data['related'] as $related)
                                                    <div class="movie-item-style-2 ">
                                                        <img src="{{ asset('/'.$related->poster_image.'.jpg') }}"
                                                             alt="{{ $related->title }} poster">
                                                        <div class="mv-item-infor">
                                                            <h6>
                                                                <a href="/movies/{{ $related->id }}">{{ $related->title }}
                                                                    <span>({{ $related->year }})</span></a></h6>
                                                            <p class="rate"><i
                                                                    class="ion-android-star"></i><span>{{ $related->ratings }}</span>
                                                            </p>
                                                            <p class="describe">{{ substr($related->synopsis,0, 300) }}
                                                                ...</p>
                                                            <p class="run-time"> Run Time: 2h21’ .
                                                                <span>MMPA: PG-13 </span> .
                                                                <span>Release date: {{ $related->year }}</span></p>

...
{{--                                </div>--}}
{{--                                <div><a href="{{ $data['details'][0]->trailer_link }}"--}}
...
{{--                        <h1 class="bd-hd">{{ $data['details'][0]->title }} <span>{{ $data['details'][0]->year }}</span>--}}
{{--                        </h1>--}}
...
{{--                                <p><span class="bd-hd">{{ $data['details'][0]->ratings }}</span><br>--}}
...
{{--                                                        <img src="{{ asset('/'.'images/uploads/userava1.jpg') }}"--}}
{{--                                                             alt="">--}}
{{--                                                        <div>--}}
{{--                                                            <h3>Best Marvel movie in my opinion</h3>--}}
{{--                                                            <div class="no-star">--}}
...
{{--                                                <div class="mv-user-review-item">--}}
{{--                                                    <div class="user-infor">--}}
{{--                                                        <img src="{{ asset('/'.'images/uploads/userava2.jpg') }}"--}}
{{--                                                             alt="">--}}
{{--                                                        <div>--}}
...
{{--                                                        </div>--}}
{{--                                                    </div>--}}
{{--                                                    <p>Avengers Age of Ultron is an excellent sequel and a worthy MCU--}}
{{--                                                        title! There are a lot of good and one thing that feels off in--}}
{{--                                                        my opinion. </p>--}}

{{--                                                    <p>THE GOOD:</p>--}}

{{--                                                    <p>First off the action in this movie is amazing, to buildings--}}
{{--                                                        crumbling, to evil blue eyed robots tearing stuff up, this movie--}}
{{--                                                        has the action perfectly handled. And with that action comes--}}
{{--                                                        visuals. The visuals are really good, even though you can see--}}
{{--                                                        clearly where they are through the movie, but that doesn't--}}
{{--                                                        detract from the experience. While all the CGI glory is taking--}}
{{--                                                        place, there are lovable characters that are in the mix. First--}}
{{--                                                        off the original characters, Iron Man, Captain America, Thor,--}}
{{--                                                        Hulk, Black Widow, and Hawkeye, are just as brilliant as they--}}
{{--                                                        are always. And Joss Whedon fixed my main problem in the first--}}
{{--                                                        Avengers by putting in more Hawkeye and him more fleshed out.--}}
{{--                                                        Then there is the new Avengers, Quicksilver, Scarletwich, and--}}
{{--                                                        Vision, they are pretty cool in my opinion. Vision in particular--}}
{{--                                                        is pretty amazing in all his scenes.</p>--}}

{{--                                                    <p>THE BAD:</p>--}}

{{--                                                    <p>The beginning of the film it's fine until towards the second act--}}
{{--                                                        and there is when it starts to feel a little rushed. Also I do--}}
{{--                                                        feel like there are scenes missing but there was talk of an--}}
{{--                                                        extended version on Blu-Ray so that's cool.</p>--}}
{{--                                                </div>--}}
{{--                                                <div class="mv-user-review-item">--}}
{{--                                                    <div class="user-infor">--}}
{{--                                                        <img src="{{ asset('/'.'images/uploads/userava3.jpg') }}"--}}
{{--                                                             alt="">--}}
{{--                                                        <div>--}}
...
{{--                                                        </div>--}}
{{--                                                    </div>--}}
{{--                                                    <p>I can't right much... it's just so forgettable...Okay, from what--}}
{{--                                                        I remember, I remember just sitting down on my seat and waiting--}}
{{--                                                        for the movie to begin. 5 minutes into the movie, boring scene--}}
{{--                                                        of Tony Stark just talking to his "dead" friends saying it's his--}}
{{--                                                        fault. 10 minutes in: Boring scene of Ultron and Jarvis having--}}
{{--                                                        robot space battles(I dunno:/). 15 minutes in: I leave the--}}
{{--                                                        theatre.2nd attempt at watching it: I fall asleep. What woke me--}}
{{--                                                        up is the next movie on Netflix when the movie was over.</p>--}}
...
{{--                                                <div class="mv-user-review-item ">--}}
{{--                                                    <div class="user-infor">--}}
{{--                                                        <img src="{{ asset('/'.'images/uploads/userava4.jpg') }}"--}}
{{--                                                             alt="">--}}
{{--                                                        <div>--}}
...
{{--                                                        reviewer although I sympathize with him somewhat. The world is--}}
{{--                                                        indeed an infinitely more complex place than the world of Marvel--}}
{{--                                                        comics with clearly identifiable heroes and villains. But I get--}}
{{--                                                        the feeling that from Robert Downey, Jr. on down the organizer--}}
{{--                                                        and prime mover as Iron Man behind the Avengers these players do--}}
{{--                                                        love doing these roles because it's a lot of fun. If they didn't--}}
{{--                                                        show that spirit of fun to the audience than these films would--}}
{{--                                                        never be made.</p>--}}

{{--                                                    <p>So in that spirit of fun Avengers: Age Of Ultron comes before us--}}
{{--                                                        and everyone looks like they're having a good time saving the--}}
{{--                                                        world. A computer program got loose and took form in this--}}
{{--                                                        dimension named Ultron and James Spader who is completely--}}
{{--                                                        unrecognizable is running amuck in the earth. No doubt Star Trek--}}
{{--                                                        fans took notice that this guy's mission is to cleanse the earth--}}
{{--                                                        much like that old earth probe NOMAD which got its programming--}}
{{--                                                        mixed up in that classic Star Trek prime story. Wouldst Captain--}}
{{--                                                        James T. Kirk of the Enterprise had a crew like Downey has at--}}
{{--                                                        his command.</p>--}}
{{--                                                    <p>My favorite is always Chris Evans because of the whole cast he--}}
{{--                                                        best gets into the spirit of being a superhero. Of all of them,--}}
{{--                                                        he's already played two superheroes, Captain America and Johnny--}}
{{--                                                        Storm the Human Torch. I'll be before he's done Evans will play--}}
{{--                                                        a couple of more as long as the money's good and he enjoys--}}
{{--                                                        it.</p>--}}
...
{{--                                                    <div class="user-infor">--}}
{{--                                                        <img src="{{ asset('/'.'images/uploads/userava5.jpg') }}"--}}
{{--                                                             alt="">--}}
{{--                                                        <div>--}}
...
{{--                                                        </div>--}}
{{--                                                    </div>--}}
{{--                                                    <p>The Avengers raid a Hydra base in Sokovia commanded by Strucker--}}
{{--                                                        and they retrieve Loki's scepter. They also discover that--}}
{{--                                                        Strucker had been conducting experiments with the orphan twins--}}
{{--                                                        Pietro Maximoff (Aaron Taylor-Johnson), who has super speed, and--}}
{{--                                                        Wanda Maximoff (Elizabeth Olsen), who can control minds and--}}
{{--                                                        project energy. Tony Stark (Robert Downey Jr.) discovers an--}}
{{--                                                        Artificial Intelligence in the scepter and convinces Bruce--}}
{{--                                                        Banner (Mark Ruffalo) to secretly help him to transfer the A.I.--}}
{{--                                                        to his Ultron defense system. However, the Ultron understands--}}
{{--                                                        that is necessary to annihilate mankind to save the planet,--}}
{{--                                                        attacks the Avengers and flees to Sokovia with the scepter. He--}}
{{--                                                        builds an armature for self-protection and robots for his army--}}
{{--                                                        and teams up with the twins. The Avengers go to Clinton Barton's--}}
{{--                                                        house to recover, but out of the blue, Nick Fury (Samuel L.--}}
{{--                                                        Jackson) arrives and convinces them to fight against Ultron.--}}
{{--                                                        Will they succeed? </p>--}}

{{--                                                    <p>"Avengers: Age of Ultron" is an entertaining adventure with--}}
{{--                                                        impressive special effects and cast. The storyline might be--}}
{{--                                                        better, since most of the characters do not show any chemistry.--}}
{{--                                                        However, it is worthwhile watching this film since the amazing--}}
{{--                                                        special effects are not possible to be described in words. Why--}}
{{--                                                        Pietro has to die is also not possible to be explained. My vote--}}
{{--                                                        is eight.</p>--}}
{{--                                                </div>--}}
{{--                                                <div class="topbar-filter">--}}
...
{{--                                                        <p class="rate"><i class="ion-android-star"></i><span>8.1</span>--}}
{{--                                                            /10</p>--}}
{{--                                                        <p class="describe">Earth's mightiest heroes must come together--}}
{{--                                                            and learn to fight as a team if they are to stop the--}}
...
{{--                                                        <p class="rate"><i class="ion-android-star"></i><span>7.8</span>--}}
{{--                                                            /10</p>--}}
{{--                                                        <p class="describe">As Steve Rogers struggles to embrace his--}}
{{--                                                            role in the modern world, he teams up with a fellow Avenger--}}
{{--                                                            and S.H.I.E.L.D agent, Black Widow, to battle a new--}}
{{--                                                            threat...</p>--}}
{{--                                                        <p class="run-time"> Run Time: 2h21’ . <span>MMPA: PG-13 </span>--}}
{{--                                                            . <span>Release: 1 May 2015</span></p>--}}
...
{{--                                                        <p class="rate"><i class="ion-android-star"></i><span>7.3</span>--}}
{{--                                                            /10</p>--}}
...
{{--                                                        <p class="rate"><i class="ion-android-star"></i><span>7.2</span>--}}
{{--                                                            /10</p>--}}
...
{{--                                                        </h6>--}}
{{--                                                        <p class="rate"><i class="ion-android-star"></i><span>7.0</span>--}}
{{--                                                            /10</p>--}}
{{--                                                        <p class="describe">When Tony Stark's world is torn apart by a--}}
{{--                                                            formidable terrorist called the Mandarin, he starts an--}}
{{--                                                            odyssey of rebuilding and retribution.</p>--}}

            ...
            <div class="row ipad-width2">
                <div class="col-md-4 col-sm-12 col-xs-12">
                    <div class="movie-img sticky-sb">
                        <img src="{{asset('/'.$details[0]->poster_image.'.jpg')}}" alt="">
                        <div class="movie-btn">
                            <div class="btn-transform transform-vertical red">
                                <div><a href="#" class="item item-1 redbtn"> <i class="ion-play"></i> Watch Trailer</a></div>
                                <div><a href="{{ $details[0]->trailer_link }}" class="item item-2 redbtn fancybox-media hvr-grow"><i class="ion-play"></i></a></div>
                            </div>
                ...
                <div class="col-md-8 col-sm-12 col-xs-12">
                    <div class="movie-single-ct main-content">
                        <h1 class="bd-hd">{{ $details[0]->title }} <span>{{ $details[0]->year }}</span></h1>
                        ...
                        <div class="movie-rate">
                            <div class="rate">
                                ...
                                <p><span class="bd-hd">{{ $details[0]->ratings }}</span><br>
                                ...
                                <div class="tab-content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8 col-sm-12 col-xs-12">
                                                ...
                                                <div class="mvsingle-item ov-item">
                                                    <a class="img-lightbox"  data-fancybox-group="gallery" href="images/uploads/image11.jpg" ><img src="{{ asset('/'.'images/uploads/image1.jpg') }}" alt=""></a>
                                                    <a class="img-lightbox"  data-fancybox-group="gallery" href="images/uploads/image21.jpg" ><img src="{{ asset('/'.'images/uploads/image2.jpg') }}" alt=""></a>
                                                    <a class="img-lightbox"  data-fancybox-group="gallery" href="images/uploads/image31.jpg" ><img src="{{ asset('/'.'images/uploads/image3.jpg') }}" alt=""></a>
                                                    <div class="vd-it">
                                                ...
                                                <div class="mvcast-item">
                                                    ...
                                                    <div class="cast-it">
                                                        <div class="cast-left">
                                                            <img src="{{ asset('/'.'images/uploads/cast2.jpg') }}" alt="">
                                                    ...
                                                    <div class="cast-it">
                                                        <div class="cast-left">
                                                            <img src="{{ asset('/'.'images/uploads/cast3.jpg') }}" alt="">
                                                    ...
                                                    <div class="cast-it">
                                                        <div class="cast-left">
                                                            <img src="{{ asset('/'.'images/uploads/cast4.jpg') }}" alt="">
                                                    ...
                                                    <div class="cast-it">
                                                        <div class="cast-left">
                                                            <img src="{{ asset('/'.'images/uploads/cast5.jpg') }}" alt="">
                                                    ...
                                                    <div class="cast-it">
                                                        <div class="cast-left">
                                                            <img src="{{ asset('/'.'images/uploads/cast6.jpg') }}" alt="">
                                                    ...
                                                    <div class="cast-it">
                                                        <div class="cast-left">
                                                            <img src="{{ asset('/'.'images/uploads/cast7.jpg') }}" alt="">
                                                    ...
                                                    <div class="cast-it">
                                                        <div class="cast-left">
                                                            <img src="{{ asset('/'.'images/uploads/cast8.jpg') }}" alt="">
                                    ...
                                    <div id="reviews" class="tab review">
                                        <div class="row">
                                            ...
                                            <div class="mv-user-review-item">
                                                <div class="user-infor">
                                                    <img src="{{ asset('/'.'images/uploads/userava2.jpg') }}" alt="">
                                                    <div>
                                            ...
                                            <div class="mv-user-review-item">
                                                <div class="user-infor">
                                                    <img src="{{ asset('/'.'images/uploads/userava3.jpg') }}" alt="">
                                                    <div>
                                            ...
                                            <div class="mv-user-review-item ">
                                                <div class="user-infor">
                                                    <img src="{{ asset('/'.'images/uploads/userava4.jpg') }}" alt="">
                                                    <div>
